...
export default function Page() { return <><JsonLd data={createBreadcrumbStructuredData(path, "Contact Relief Plus")} /><InfoPageShell path={path} breadcrumbLabel="Contact" eyebrow="Contact Relief Plus" title="Start with a phone call." description="Call (337) 565-4200 to arrange a visit at our Lafayette clinic. Tell us what you would like help with, and we can explain the next step. Appointments are scheduled by phone." heroPoints={["Call (337) 565-4200", "112 Arabian Dr., Lafayette, LA 70507", "Fax referrals to (337) 565-4201"]} sections={[
  ...
  { eyebrow: "Scheduling", title: "You do not need to choose a treatment before calling.", paragraphs: ["Tell us what hurts and which activities are difficult. You can ask for an assessment without knowing the diagnosis or choosing a treatment first."] },
