...
export default function SiteHeader({ currentPath }: { currentPath?: string }) {
  ...
  return <><JsonLd data={medicalBusinessJsonLd} /><header ref={headerRef} className="site-header-safe relative z-50 border-b border-[#12233f]/10 bg-[#f7f5ef]/95 text-[#12233f]"><div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 sm:gap-5 sm:px-6 sm:py-5 lg:px-8">
