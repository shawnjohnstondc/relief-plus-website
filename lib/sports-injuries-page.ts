...
export const sportsInjuriesPage: PillarPageData = {
  ...
  heroPoints: [
    ...
    "Return to activity progresses beyond pain reduction alone",
  ],
  overviewTitle: "Sports injuries can follow one clear event or build as demand exceeds current capacity.",
  overviewParagraphs: [
  ...
  serviceTitle: "A functional sports injury evaluation connects examination findings to the athlete’s actual task.",
  serviceSteps: [
    {
      title: "Clarify the injury and diagnosis",
      description:
    ...
    {
      title: "Measure movement and physical capacity",
      description:
    ...
    {
      title: "Examine the sport-specific demand",
      description:
  ...
  whoTitle: "The same painful area can face very different demands in different athletes.",
  whoDescription:
  ...
  considerations: [
    ...
    {
      title: "Jumping, landing, and cutting",
      description:
    ...
    {
      title: "Throwing and overhead activity",
      description:
  ...
  conditions: [
    { title: "Rotator Cuff Pain", href: "/rotator-cuff-pain-lafayette" },
    { title: "Shoulder Pain", href: "/shoulder-pain-lafayette" },
    { title: "Tennis Elbow", href: "/tennis-elbow-lafayette" },
    { title: "Knee Pain", href: "/knee-pain-lafayette" },
    { title: "Knee Osteoarthritis", href: "/knee-osteoarthritis-lafayette" },
    { title: "Achilles Tendinopathy", href: "/achilles-tendinopathy-lafayette" },
  ...
  educationSections: [
    {
      eyebrow: "Movement and Load",
      title: "The evaluation considers both the injured tissue and how the athlete uses it.",
      paragraphs: [
    ...
    },
    {
      ...
      title: "Load management is a balance between current capacity and the dose of sport.",
      paragraphs: [
    ...
    },
    {
      ...
      title: "Less pain is valuable, but it may not represent full readiness for practice or competition.",
      paragraphs: [
    ...
    {
      eyebrow: "Imaging and Referral",
      title: "Some sports injuries need imaging or specialty evaluation before rehabilitation leads.",
      paragraphs: [
    ...
    {
      eyebrow: "When to Seek Prompt Care",
      title: "Urgent findings are uncommon, but athletes and parents should know what changes the timeline.",
      paragraphs: [
  ...
  faqs: [
    {
      question: "Do I need imaging for a sports injury?",
      answer:
    ...
    {
      question: "Can I keep training while I recover?",
      answer:
    ...
    {
      question: "Is being pain-free enough to return to competition?",
      answer:
    ...
    {
      question: "Will I need every treatment Relief Plus offers?",
      answer:
  ...
  pageSources: [
    {
      label: "ACSM: Team Physician Consensus Statements",
      href: "https://acsm.org/education-resources/pronouncements-scientific-communications/team-physician-consensus-statements/",
      note: "Consensus resources addressing musculoskeletal injury assessment, load and recovery, and return to sport.",
    },
    {
      label: "AAOS OrthoInfo: Stress Fractures",
      href: "https://orthoinfo.aaos.org/en/diseases--conditions/stress-fractures/",
      note: "Patient guidance on bone-stress injury evaluation, imaging, recovery, and gradual return to activity.",
    },
  ],
  ctaTitle: "Start with a sports injury evaluation built around your activity.",
  ctaDescription:
